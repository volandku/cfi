Форк сделан, так как плагин работал местами некорректно

## Список правок

При экспорте в столбце fulltext была строка fulltext
FIXED

При выборе категории экспорт шёл без учета вложенности
FIXED


при экспорте всё равно зачем-то конвертился в CP1251, даже если не стояла галочка
FIXED - и добавлена опция как ставить галочку по умолчанию

при экспорте добавлена строка categoryname с путем категории


при иморте категория опознавалась только по id
